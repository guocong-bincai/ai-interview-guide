...
> **⚠️ 
本次更新(v3.148)：17新增Q51 AI编程Token成本优化七招(精准提示词/compact/claudeignore/MCP按需/模型分层/子代理)
...
#### 📌 01-basic-concepts（+2 题）✅ 已实现（v3.132）
| # | 待补充题目 |
|---|-----------|
...
## 📚 数据更新（v3.129 - 2026-08-10）

| 序号 | 模块 | 新增内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🆕 | [🧠 LLM基础概念（新增Q20-25）](docs/01-basic-concepts/) | Q20 Logits生成流程/Softmax、Q21 解码策略对比（贪心/Beam/采样）、Q22 Temperature=0非确定性、Q23 重复惩罚防复读、Q24 EOS停止符、Q25 Decoder-only架构 | 🔥🔥🔥🔥🔥 | +6 |
...
*版本: v3.148 | 更新: 2026-08-10 | by 二狗子 🐕*
...
## 📚 数据更新（v3.146 - 2026-08-10）

| 序号 | 模块 | 新增内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🆕 | [🤖 AI Agent基础（新增Q34）](docs/05-ai-agent-basics/) | Q34 确定性vs概率性编程：思维转变框架(调试→评估/单测→评估集/try-catch→降级重试兜底)、应对不确定性三件套(结构化输出/统计评估/防御编程)、Agent工程化五要素(可靠性/可观测性/成本/评估/Multi-Agent)、渐进式复杂度黄金判断 | 🔥🔥🔥🔥🔥 | +1 |

*版本: v3.146 | 更新: 2026-08-10 | by 二狗子 🐕*

---

## 📚 数据更新（v3.145 - 2026-08-10）

| 序号 | 模块 | 更新内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🔄 | [📚 RAG系统（补充排查框架）](docs/03-rag-system/) | RAG回答不准四层排查清单：Chunk策略(地基)/检索质量(相似≠相关)/上下文组装(矛盾与拒答)/用户Query(改写+追问)；90%问题不是模型是检索 | 🔥🔥🔥🔥🔥 | 补充1 |
| 🔄 | [📄 简历面试技巧（补充631法则）](docs/16-resume-interview-tips/) | 2026面试时间分配631法则：60%项目/30%八股/10%算法+八股P0/P1/P2优先级+答辩弹药原则 | 🔥🔥🔥🔥 | 补充1 |

*版本: v3.145 | 更新: 2026-08-10 | by 二狗子 🐕*
...
## 📚 数据更新（v3.143 - 2026-08-10）

| 序号 | 模块 | 更新内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🔄 | [🎓 模型训练（Q3增强）](docs/07-model-training/) | RAG vs Fine-tuning补充：带小抄vs补课比喻、工程落地四维度对比(知识更新成本/可解释性/工程复杂度/成本控制)、选型判断(知识频繁更新+溯源→RAG，固定风格/专业语言→微调) | 🔥🔥🔥🔥🔥 | 增强1 |

*版本: v3.143 | 更新: 2026-08-10 | by 二狗子 🐕*

---

## 📚 数据更新（v3.142 - 2026-08-10）

| 序号 | 模块 | 新增内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🆕 | [🤖 AI Agent基础（新增Q32）](docs/05-ai-agent-basics/) | Q32 千轮上下文关联：短期+长期分层记忆、分层摘要算法(轮次摘要→会话总摘要)、向量召回机制、结构化实体记忆、千轮压缩95%+成本平衡 | 🔥🔥🔥🔥🔥 | +1 |
| 🔄 | [📚 RAG系统（补充幻觉治理）](docs/03-rag-system/) | 幻觉治理补充：全链路四侧框架(检索/生成/校验/迭代)、bad case回流闭环、金融场景关键数字强校验 | 🔥🔥🔥🔥🔥 | 补充1 |

*版本: v3.142 | 更新: 2026-08-10 | by 二狗子 🐕*

---

## 📚 数据更新（v3.141 - 2026-08-10）

| 序号 | 模块 | 新增内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🆕 | [📄 简历面试技巧（新增Q14）](docs/16-resume-interview-tips/) | Q14 AI Agent后端岗JD拆解：4大能力模块(基础盘/核心竞争力/进阶项/压舱石)+3阶段转型路线(后端基础→AI工程化→项目落地)+量化表达模板(53%→93%句式) | 🔥🔥🔥🔥🔥 | +1 |

*版本: v3.141 | 更新: 2026-08-10 | by 二狗子 🐕*
...
## 📚 数据更新（v3.139 - 2026-08-10）

| 序号 | 模块 | 新增内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🆕 | [🏭 生产部署（新增Q20）](docs/10-production-deployment/) | Q20 RAG项目上线后怎么治理：策略热加载、Shadow影子/Canary金丝雀/全量三步灰度、质量门禁(Recall/NDCG/Faithfulness)、一键回滚、请求级成本归因；Demo级vs生产级差距 | 🔥🔥🔥🔥🔥 | +1 |

*版本: v3.139 | 更新: 2026-08-10 | by 二狗子 🐕*

---

## 📚 数据更新（v3.138 - 2026-08-10）

| 序号 | 模块 | 更新内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🔄 | [🚀 RAG高级优化（补充追问点）](docs/20-rag-advanced-optimization/) | RRF融合补充面试追问点：RRF只看排名不看原始分数，向量0-1分与BM25 0-20分无需归一化即可融合(对比加权融合需先MinMax) | 🔥🔥🔥🔥🔥 | 补充1 |

*版本: v3.138 | 更新: 2026-08-10 | by 二狗子 🐕*

---

## 📚 数据更新（v3.137 - 2026-08-10）

| 序号 | 模块 | 更新内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🔄 | [📚 RAG系统（补充优化方法论）](docs/03-rag-system/) | RAG效果优化题补充：优化金字塔方法论(基础→召回→高级三层，80%问题根源在数据质量)+五大常见坑(切分不合理/召回太少/召回太多/上下文冲突/相似度陷阱) | 🔥🔥🔥🔥🔥 | 补充2 |

*版本: v3.137 | 更新: 2026-08-10 | by 二狗子 🐕*
...
## 📚 数据更新（v3.135 - 2026-08-10）

| 序号 | 模块 | 更新内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🔄 | [📚 全仓库大扫除](docs/) | 33处重复Q编号重新编号(05/06/09/10/12/13/14/15/17/19/20/23模块)；12个模块编号连续化；4个模块details配对修复(09/13/14/17，其中17删除Q43空壳+修复损坏格式)；GPT-3.5/gpt-4等过时模型引用批量更新为DeepSeek-V4-Flash/Qwen系列 | 🔥🔥🔥🔥🔥 | 全量整理 |

*版本: v3.135 | 更新: 2026-08-10 | by 二狗子 🐕*
...
## 📚 数据更新（v3.132 - 2026-08-10）

| 序号 | 模块 | 更新内容 | 高频度 | 题数 |
|------|------|----------|--------|------|
| 🔄 | [🧠 LLM基础概念（优化4题）](docs/01-basic-concepts/) | Q4 过时模型对比表→改为"LLM与传统ML区别(生成式vs判别式)"；Q12 灾难性遗忘(与07微调模块重复)→改为"LLM为什么是概率模型(输出不确定性+T=0工程处理)"；Q13 幻觉部分与Q5重复→改为"幻觉检测与量化(引用溯源/RAGAS忠实度/交叉验证)"；Q17 时效性模型价格表→改为"LLM选型方法论(质量×速度×成本三维权衡+模型路由降本)" | 🔥🔥🔥🔥🔥 | 优化4 |

*版本: v3.132 | 更新: 2026-08-10 | by 二狗子 🐕*
