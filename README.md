...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>🧪 内容可以持续校验</h3>
      <p>678 道题按 28 个专题组织，并用自动审计检查失效链接、重复题和缺少条件的数据；题目质量优先于单纯堆数量。</p>
    </td>
  </tr>
</table>
...
<p align="center"><b>01–28 共 28 个专题、678 道题，现已全部完成逐题配图。</b></p>
...
除了 667 道面试题，仓库还收录了 **11 份、495 页**的《动手学大模型》系列课件。它们不是单纯的书单链接，而是一套从基础方法、动手实验走到安全与 Agent 前沿的课程型 PDF，适合在刷题后继续补原理、看案例和设计复现实验。
